...
export const ALL_TOOLS = [
  {
    ...
    description:
      "Create itemized client estimates, service quotes, and billing previews instantly without cloud uploads.",
    category: "Finance",
  ...
  },
  {
    ...
    description:
      "Quickly create and export attendance sheets for teams, employees, or classes.",
    category: "HR & Work",
  ...
  },
  {
    ...
    description:
      "Generate itemized electrical estimates, job cards, and tax invoices.",
    category: "Finance",
  ...
  },
  {
    ...
    description:
      "Combine multiple PDF documents into a single organized file client-side.",
    category: "PDF Tools",
    path: "/pdf/merge-pdf",
  ...
  },
  {
    ...
    description:
      "Rotate, reorder, or delete specific pages from your PDF documents.",
    category: "PDF Tools",
